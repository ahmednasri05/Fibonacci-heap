...
int main() {
    ...
    Patient patient1("Alice", 12345, 25, 4, "Fractured arm");
    patientHashMap.insertDouble(patient1);
    Patient result = patientHashMap.searchDouble(patient1);
    ...
    // patientHashMap.insertDouble(patient2);
    // patientHashMap.insertDouble(patient3);
    // result = patientHashMap.searchDouble(patient2);
    // cout << "Test case 2a: " << (result != nullptr ? "Passed" : "Failed") << endl;
    // result = patientHashMap.searchDouble(patient3);
    // cout << "Test case 2b: " << (result != nullptr ? "Passed" : "Failed") << endl;

    // // Test case 3: Remove a patient and search for it
    // patientHashMap.removeDouble(patient1);
    // result = patientHashMap.searchDouble(patient1);
    // cout << "Test case 3: " << (result == nullptr ? "Passed" : "Failed") << endl;

    // // Test case 4: Insert patients, remove one, and search for all
    // patientHashMap.insertDouble(patient1);
    // patientHashMap.removeDouble(patient2);
    // result = patientHashMap.searchDouble(patient1);
    ...
    // patientHashMap.insertDouble(patient4);
    // patientHashMap.insertDouble(patient5);
    // patientHashMap.insertDouble(patient6);
    // patientHashMap.insertDouble(patient7);
    // patientHashMap.insertDouble(patient8);
    // patientHashMap.insertDouble(patient9);
    // patientHashMap.insertDouble(patient10);

    // result = patientHashMap.searchDouble(patient4);
    // cout << "Test case 5a: " << (result != nullptr ? "Passed" : "Failed") << endl;
    // result = patientHashMap.searchDouble(patient5);
    // cout << "Test case 5b: " << (result != nullptr ? "Passed" : "Failed") << endl;
    // result = patientHashMap.searchDouble(patient6);
    // cout << "Test case 5c: " << (result != nullptr ? "Passed" : "Failed") << endl;
    // result = patientHashMap.searchDouble(patient7);
    // cout << "Test case 5d: " << (result != nullptr ? "Passed" : "Failed") << endl;
    // result = patientHashMap.searchDouble(patient8);
    // cout << "Test case 5e: " << (result != nullptr ? "Passed" : "Failed") << endl;
    // result = patientHashMap.searchDouble(patient9);
    // cout << "Test case 5f: " << (result != nullptr ? "Passed" : "Failed") << endl;
    // result = patientHashMap.searchDouble(patient10);
